//
//  ExerciseDetailsScreenFailureUITests.swift
...
final class ExerciseDetailsScreenFailureUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        app.launchEnvironment = [
            ...
            "-variation-networking-success":"0"
        ]
        app.launch()
    }
    ...
    func test_exercise_details_loaded_successful() {
        ...
        XCTAssertTrue(app.staticTexts["Not found."].exists)
    }
}
